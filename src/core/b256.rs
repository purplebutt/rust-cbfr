...
/// # example:
/// ```
/// use cbfr::core::b256::B256;
///
/// let b = B256::from("some string");
...
/// Create B256 instance from &str
/// # example
/// ```
/// use cbfr::core::b256::B256;
///
/// let b: B256 = "some string".into();
/// ```
/// # panic
/// Panic if "some string" len > cbfr::core::b256::MAX
///
impl From<&str> for B256 {
...
impl B256 {
   /// create new buffer with capacity of b256::MAX
   /// # example
   /// ```
   /// use cbfr::core::b256::B256;
   /// let b = B256::new();
   ...
   ///
    ...
    /// (b256::MAX), which is the maximum value of data (in bytes) a buffer can hold
    ...
    /// b256::MAX constant value.
    /// # example
    /// ```
    /// use cbfr::core::b256::B256;
    /// use cbfr::core::b256::MAX;
    ///
    /// let b = B256::new();
    ...
    /// use cbfr::core::b256::B256;
    ///
    /// let mut b: B256 = "some string".into();
    /// b.clear();
    /// assert_eq!(0, b.len());
    /// assert_eq!("", b.as_str());
    /// assert_eq!("", b.to_string());
    ...
    /// use cbfr::core::b256::B256;
    ///
    /// let mut ba: B256 = "coding".into();
    /// let bb: B256 = "I love ".into();
    ///
    /// ba.prepend(bb);
    ...
    /// use cbfr::core::b256::B256;
    ///
    /// let mut ba: B256 = "I love".into();
    /// let bb: B256 = " coding".into();
    ///
    /// ba.append(bb);
    /// assert_eq!("I love coding", ba.as_str());
    /// assert_eq!(13, ba.len());
    ...
    /// use cbfr::core::b256::B256;
    ///
    /// let mut b: B256 = "Happy codin".into();
    ///
    /// b.append_ch('g');
    ...
    /// use cbfr::core::b256::B256;
    ///
    /// let mut b1: B256 = "Amng".into();
    /// let mut b2: B256 = "azi".into();
    ///
    ...
    /// use cbfr::core::b256::B256;
    ///
    /// let mut b: B256 = "damN i loVe iNdoNesIA".into();
    ///
    /// b.to_proper();
