...
pub const MAX: usize = 125;

/// 8 bytes buffer
/// # example:
/// ```
/// use cbfr::core::b125::B125;
///
/// let b = B125::from("some string");
...
/// Create B125 instance from &str
/// # example
/// ```
/// use cbfr::core::b125::B125;
///
/// let b: B125 = "some string".into();
/// ```
/// # panic
/// Panic if "some string" len > cbfr::core::b125::MAX
///
impl From<&str> for B125 {
...
impl B125 {
   /// create new buffer with capacity of b125::MAX
   /// # example
   /// ```
   /// use cbfr::core::b125::B125;
   /// let b = B125::new();
   ...
   ///
    ...
    /// (b125::MAX), which is the maximum value of data (in bytes) a buffer can hold
    ...
    /// b125::MAX constant value.
    /// # example
    /// ```
    /// use cbfr::core::b125::B125;
    /// use cbfr::core::b125::MAX;
    ///
    /// let b = B125::new();
    ...
    /// use cbfr::core::b125::B125;
    ///
    /// let mut b: B125 = "some string".into();
    /// b.clear();
    /// assert_eq!(0, b.len());
    /// assert_eq!("", b.as_str());
    /// assert_eq!("", b.to_string());
    ...
    /// use cbfr::core::b125::B125;
    ///
    /// let mut ba: B125 = "coding".into();
    /// let bb: B125 = "I love ".into();
    ///
    /// ba.prepend(bb);
    ...
    /// use cbfr::core::b125::B125;
    ///
    /// let mut ba: B125 = "I love".into();
    /// let bb: B125 = " coding".into();
    ///
    /// ba.append(bb);
    /// assert_eq!("I love coding", ba.as_str());
    /// assert_eq!(13, ba.len());
    ...
    /// use cbfr::core::b125::B125;
    ///
    /// let mut b: B125 = "Happy codin".into();
    ///
    /// b.append_ch('g');
    ...
    /// use cbfr::core::b125::B125;
    ///
    /// let mut b1: B125 = "Amng".into();
    /// let mut b2: B125 = "azi".into();
    ///
    ...
    /// use cbfr::core::b125::B125;
    ///
    /// let mut b: B125 = "damN i loVe iNdoNesIA".into();
    ///
    /// b.to_proper();
