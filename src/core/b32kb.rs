...
pub const MAX: usize = 32768; //32kb

/// 8 bytes buffer
/// # example:
/// ```
/// use cbfr::core::b32kb::B32KB;
///
/// let b = B32KB::from("some string");
...
/// Create B32KB instance from &str
/// # example
/// ```
/// use cbfr::core::b32kb::B32KB;
///
/// let b: B32KB = "some string".into();
/// ```
/// # panic
/// Panic if "some string" len > cbfr::core::b32kb::MAX
///
impl From<&str> for B32KB {
...
impl B32KB {
   /// create new buffer with capacity of b32kb::MAX
   /// # example
   /// ```
   /// use cbfr::core::b32kb::B32KB;
   /// let b = B32KB::new();
   ...
   ///
    ...
    /// (b32kb::MAX), which is the maximum value of data (in bytes) a buffer can hold
    ...
    /// b32kb::MAX constant value.
    /// # example
    /// ```
    /// use cbfr::core::b32kb::B32KB;
    /// use cbfr::core::b32kb::MAX;
    ///
    /// let b = B32KB::new();
    ...
    /// use cbfr::core::b32kb::B32KB;
    ///
    /// let mut b: B32KB = "some string".into();
    /// b.clear();
    /// assert_eq!(0, b.len());
    /// assert_eq!("", b.as_str());
    /// assert_eq!("", b.to_string());
    ...
    /// use cbfr::core::b32kb::B32KB;
    ///
    /// let mut ba: B32KB = "coding".into();
    /// let bb: B32KB = "I love ".into();
    ///
    /// ba.prepend(bb);
    ...
    /// use cbfr::core::b32kb::B32KB;
    ///
    /// let mut ba: B32KB = "I love".into();
    /// let bb: B32KB = " coding".into();
    ///
    /// ba.append(bb);
    /// assert_eq!("I love coding", ba.as_str());
    /// assert_eq!(13, ba.len());
    ...
    /// use cbfr::core::b32kb::B32KB;
    ///
    /// let mut b: B32KB = "Happy codin".into();
    ///
    /// b.append_ch('g');
    ...
    /// use cbfr::core::b32kb::B32KB;
    ///
    /// let mut b1: B32KB = "Amng".into();
    /// let mut b2: B32KB = "azi".into();
    ///
    ...
    /// use cbfr::core::b32kb::B32KB;
    ///
    /// let mut b: B32KB = "damN i loVe iNdoNesIA".into();
    ///
    /// b.to_proper();
