...
/// # example:
/// ```
/// use cbfr::core::b512::B512;
///
/// let b = B512::from("some string");
...
/// Create B512 instance from &str
/// # example
/// ```
/// use cbfr::core::b512::B512;
///
/// let b: B512 = "some string".into();
/// ```
/// # panic
/// Panic if "some string" len > cbfr::core::b512::MAX
///
impl From<&str> for B512 {
...
impl B512 {
   /// create new buffer with capacity of b512::MAX
   /// # example
   /// ```
   /// use cbfr::core::b512::B512;
   /// let b = B512::new();
   ...
   ///
    ...
    /// (b512::MAX), which is the maximum value of data (in bytes) a buffer can hold
    ...
    /// b512::MAX constant value.
    /// # example
    /// ```
    /// use cbfr::core::b512::B512;
    /// use cbfr::core::b512::MAX;
    ///
    /// let b = B512::new();
    ...
    /// use cbfr::core::b512::B512;
    ///
    /// let mut b: B512 = "some string".into();
    /// b.clear();
    /// assert_eq!(0, b.len());
    /// assert_eq!("", b.as_str());
    /// assert_eq!("", b.to_string());
    ...
    /// use cbfr::core::b512::B512;
    ///
    /// let mut ba: B512 = "coding".into();
    /// let bb: B512 = "I love ".into();
    ///
    /// ba.prepend(bb);
    ...
    /// use cbfr::core::b512::B512;
    ///
    /// let mut ba: B512 = "I love".into();
    /// let bb: B512 = " coding".into();
    ///
    /// ba.append(bb);
    /// assert_eq!("I love coding", ba.as_str());
    /// assert_eq!(13, ba.len());
    ...
    /// use cbfr::core::b512::B512;
    ///
    /// let mut b: B512 = "Happy codin".into();
    ///
    /// b.append_ch('g');
    ...
    /// use cbfr::core::b512::B512;
    ///
    /// let mut b1: B512 = "Amng".into();
    /// let mut b2: B512 = "azi".into();
    ///
    ...
    /// use cbfr::core::b512::B512;
    ///
    /// let mut b: B512 = "damN i loVe iNdoNesIA".into();
    ///
    /// b.to_proper();
